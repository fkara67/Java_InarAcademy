...
public class Exercises05_42 {

	public static void main(String[] args) {
		Scanner input = new Scanner(System.in);
		System.out.println("Enter your target commission: ");
		double targetCommission = input.nextDouble();
		double sales = 0;
		double commission = 0, commission1 = 0, commission2 = 0, commission3 = 0;
		for (sales = 0.01; commission <= targetCommission; sales += 0.01) {
		...
		targetCommission + " is %2.2f", sales);
	}
